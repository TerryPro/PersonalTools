...
<template>
  <div v-if="boardContent" class="relative size-full">
    ...
    <div class="absolute inset-x-0 top-4 z-50 px-8">
      <h1
        v-if="!boardTitleEditing"
        class="mb-1 max-h-12 w-full overflow-hidden break-words rounded-md bg-transparent py-1 pr-8 text-2xl font-bold"
    ...
    <div
      ...
      class="custom-scrollbar-horizontal flex h-full flex-col overflow-y-hidden"
    >
...
import { PhArrowBendUpLeft, PhHashStraight, PhTrash, PhCopy, PhPencil, PhExport, PhPushPin } from "@phosphor-icons/vue";
...
const emit = defineEmits<{
  (e: "boardDeleted", id: string): void;
  (e: "boardDuplicated"): void;
}>();
