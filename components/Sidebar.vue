...
<template>
  <nav
    class="border-elevation-1 bg-sidebar z-10 flex h-full flex-col items-center justify-between overflow-hidden border-r-2 px-8 pb-6 pt-5 shadow-md"
  >
